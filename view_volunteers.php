...
<!-- 					<li class="parent"><a href="contact.html">Contact Us</a></li> -->
		...
		<div class="page-title-wrap">
			...
			<h2 class="page-title">View volunteers</h2>
			</div><!-- /.container -->
		...
		<!-- END BERADCRUMB AND PAGE TITLE -->
			...
			if(!empty($_GET['key'])){
				$key=$_GET['key'];
					$query = "SELECT * from user,volunteers_in where volunteers_in.contest_id = '$key' and user.emailid=volunteers_in.emailid";
					$result = mysql_query($query) or die(mysql_error());
					if(mysql_num_rows($result)==0){?>
						<div class="section">
						<div class="container">
						<p class="text-center text-slogan">
						<b>This contest has no volunteers yet!</b>
						</p>
						</div><!-- /.container -->
						</div>
						<?php
